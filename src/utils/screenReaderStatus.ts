...
/**
 * Screen-reader (VoiceOver / TalkBack) status — syntax sugar over RN's
 * `AccessibilityInfo`, parallel to the keyboard-status API. No native module
 * needed. The listener payload mirrors `keyboardStatusListener` (`{ status }`).
 */
